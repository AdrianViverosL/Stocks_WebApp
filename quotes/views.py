...
def home(request):
    ...
    if request.method == "POST":
        ...
        api_key ="pk_20fbf594ed594d7b9bd58d7dc772822b"
        ...
        return render(request, 'home.html', {'ticker': "Welcome to your Stock portfolio web app. Please enter a valid quote on the form."})
